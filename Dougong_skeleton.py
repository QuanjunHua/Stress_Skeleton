...
class DG_Auto_selfmod():
    ...
    def __init__(self, path_pack, args):
        ...
        self.pathh, self.path_model, self.resu1_path, self.path_ansys, self.path_custom = path_pack
        self.path_error = self.pathh + "\\" + self.filename + ".err"
        self.resultfile = self.pathh + "\\" + self.filename + ".rst"
        
        self.E_L = 10000               # 顺纹弹性模量11000~115790MPa
        self.E_R = 800                 # 径向弹性模量500~1977MPa
        self.E_T = 800                 # 弦向弹性模量500~1450MPa
        self.v_12 = 0.35                 # 顺径面泊松比0.027~0.35
        self.v_31 = 0.028                # 顺弦面泊松比0.044~0.05
        self.v_23 = 0.4                  # 径弦面泊松比0.373~0.71
        self.G_12 = 650                # 顺径面剪切模量650~1310MPa
        self.G_13 = 650                # 顺弦面剪切模量650~912MPa
        self.G_23 = 60                 # 径弦面剪切模量60~274MPa
        self.viscous_1 = 0.0001          # 粘性系数一般取0.0001-0.005
        self.Lch = args.mesh_size                  # 材料特征长度为单元体积开三根
        self.Dens_mu = args.Rou_Timber              # 木材密度取500kg/m^3
        self.mocaf = 0.4                 # 摩擦系数

        # 材料参数
        self.E_Timber = args.E_Timber
        self.P_Timber = args.P_Timber
        self.Rou_Timber = args.Rou_Timber
        self.SECTDATA_b = args.SECTDATA_b
        self.SECTDATA_h = args.SECTDATA_h

        # 单元类型
        self.ET_Timber = args.ET_Timber

        # 网格尺寸
        self.mesh_size = args.mesh_size

        # 求解设置
        self.BC_type = args.BC_type
        self.multer = args.multer
        self.YEta = args.YEta
        self.YEta2 = args.YEta2
        self.con_value1 = args.con_value1
        self.con_value2 = args.con_value2
        self.Number_mode = args.Number_mode
        self.difference_method_flag = args.difference_method_flag

        # 抗震设置
        self.num_sub = args.num_sub
        self.Yes_no_largeD = args.Yes_no_largeD
        self.earth_dirction = args.earth_dirction
        self.Hezai1 = args.Hezai1
        self.Hezai2 = args.Hezai2
        # self.Hezai3 = args.Hezai3
        self.Steel = args.Steel
        ...
        # # 简化垂直荷载点线
        # self.KG_1 = args.KG_1
        # self.LG_11 = args.LG_11
        # self.LG_12 = args.LG_12
        # self.LG_21 = args.LG_21
        # self.LG_22 = args.LG_22
        # # 简化水平荷载点
        # self.KD_1 = args.KD_1
        # self.KD_2 = args.KD_2

        # 客制Ansys设置
        self.ifcustom = False #表示是否打开自定义ansys版本
